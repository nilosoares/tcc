...
class Q6 extends AbstractQuery {
    ...
    protected void replaceParameters() {
        ...
        FileSystemHelper.findAndReplace(iTemplate, "__PARAM_QUANTITY__", quantity.toString());
        ...
        FileSystemHelper.findAndReplace(iTemplate, "__PARAM_QUANTITY__", discount.toString());
