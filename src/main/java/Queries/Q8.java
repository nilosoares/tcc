...
class Q8 extends AbstractQuery {
    ...
    protected void replaceParameters() {
        ...
        FileSystemHelper.findAndReplace(iTemplate, "__PARAM_COUNTRY__", countryName);
        ...
        FileSystemHelper.findAndReplace(iTemplate, "__PARAM_REGION__", regionName);
        ...
        FileSystemHelper.findAndReplace(iTemplate, "__PARAM_TYPE__", type);
